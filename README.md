...
Árvore atual de headers e classes
CV_DSP/Core
...
A camada Guitar já é uma composição de módulos existentes. Por exemplo, AmpSimulator.hpp inclui TubePreamp, ToneStack, MarshallToneStack, PowerAmp, CabinetSimulator e NoiseGate, sendo uma arquitetura de alto nível já parcialmente composta. 
