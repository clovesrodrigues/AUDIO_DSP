...
class SuperReverbVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    SuperReverbVST3Processor ();
    ~SuperReverbVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new SuperReverbVST3Processor;
    }
...
protected:
    using DSP = cvdsp::reverb::SuperReverbDSP<float>;
