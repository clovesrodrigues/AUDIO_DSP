...
class DeluxeReverbVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    DeluxeReverbVST3Processor ();
    ~DeluxeReverbVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new DeluxeReverbVST3Processor;
    }
...
protected:
    using DSP = cvdsp::reverb::DeluxeReverbDSP<float>;
