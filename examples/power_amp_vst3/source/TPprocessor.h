...
#include "CV_DSP/Guitar/PowerAmp.hpp"
...
class PowerAmpVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    PowerAmpVST3Processor ();
    ~PowerAmpVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new PowerAmpVST3Processor;
    }
...
protected:
    using DSP = cvdsp::PowerAmp<float>;
