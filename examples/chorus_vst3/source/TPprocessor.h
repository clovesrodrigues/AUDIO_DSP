...
#include "CV_DSP/Effects/Chorus.hpp"
...
class ChorusVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    ChorusVST3Processor ();
    ~ChorusVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new ChorusVST3Processor;
    }
