...
#include "CV_DSP/Spatial/MidSide.hpp"
#include "CV_DSP/Manager/ParameterManager.hpp"

namespace CV {

class MidSideVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    MidSideVST3Processor ();
    ~MidSideVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new MidSideVST3Processor;
    }
...
protected:
    using DSP = cvdsp::spatial::MidSide<float>;
