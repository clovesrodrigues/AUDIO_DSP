...
#if SPRING_REVERB_VST3_ENABLE_CV_GUI
...
tresult PLUGIN_API SpringReverbVST3Controller::initialize (FUnknown* context)
{
...
tresult PLUGIN_API SpringReverbVST3Controller::terminate ()
{
    return EditControllerEx1::terminate ();
}

tresult PLUGIN_API SpringReverbVST3Controller::setComponentState (IBStream* state)
{
    if (!state)
        return kResultFalse;
...
tresult PLUGIN_API SpringReverbVST3Controller::setState (IBStream* /*state*/)
{
    return kResultTrue;
}

tresult PLUGIN_API SpringReverbVST3Controller::getState (IBStream* /*state*/)
{
    return kResultTrue;
}

IPlugView* PLUGIN_API SpringReverbVST3Controller::createView (FIDString name)
{
