...
class SpringReverbVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    SpringReverbVST3Processor ();
    ~SpringReverbVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new SpringReverbVST3Processor;
    }
...
protected:
    using DSP = cvdsp::reverb::SpringReverb<float>;
