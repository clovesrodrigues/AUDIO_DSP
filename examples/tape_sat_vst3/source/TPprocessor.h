...
class TapeSatVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    TapeSatVST3Processor ();
    ~TapeSatVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new TapeSatVST3Processor;
    }
