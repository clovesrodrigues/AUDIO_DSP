...
#include "CV_DSP/Effects/Flanger.hpp"
...
class FlangerVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    FlangerVST3Processor ();
    ~FlangerVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new FlangerVST3Processor;
    }
