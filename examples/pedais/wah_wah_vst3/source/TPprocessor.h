...
class WahWahVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    WahWahVST3Processor ();
    ~WahWahVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new WahWahVST3Processor;
    }
...
protected:
    using DSP = cvdsp::guitar::pedals::WahWahDSP<float>;
    ...
    static double tempoFromProcessContext (const Steinberg::Vst::ProcessData& data) noexcept;
    static double ppqFromProcessContext (const Steinberg::Vst::ProcessData& data) noexcept;

    std::array<DSP, 2> processors_ {};
    cvdsp::control::ExpressionEngine<float> expressionEngine_ {};
    ParameterState parameterState_ {};
    double sampleRate_ {44100.0};
    bool expressionEngineEnabled_ {false};
    float manualExpression_ {0.0f};
};
