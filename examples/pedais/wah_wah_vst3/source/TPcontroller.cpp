...
tresult PLUGIN_API WahWahVST3Controller::initialize (FUnknown* context)
{
...
tresult PLUGIN_API WahWahVST3Controller::terminate ()
{
    return EditControllerEx1::terminate ();
}

tresult PLUGIN_API WahWahVST3Controller::setComponentState (IBStream* state)
{
    if (!state)
        return kResultFalse;
...
tresult PLUGIN_API WahWahVST3Controller::setState (IBStream* /*state*/)
{
    return kResultTrue;
}

tresult PLUGIN_API WahWahVST3Controller::getState (IBStream* /*state*/)
{
    return kResultTrue;
}

IPlugView* PLUGIN_API WahWahVST3Controller::createView (FIDString name)
{
