...
ChainsawMetalVST3Processor::ChainsawMetalVST3Processor ()
{
    setControllerClass (kChainsawMetalVST3ControllerUID);
...
tresult PLUGIN_API ChainsawMetalVST3Processor::initialize (FUnknown* context)
{
...
tresult PLUGIN_API ChainsawMetalVST3Processor::terminate ()
{
    return AudioEffect::terminate ();
}

tresult PLUGIN_API ChainsawMetalVST3Processor::setActive (TBool state)
{
    if (state)
    {
...
tresult PLUGIN_API ChainsawMetalVST3Processor::setupProcessing (Vst::ProcessSetup& newSetup)
{
...
tresult PLUGIN_API ChainsawMetalVST3Processor::canProcessSampleSize (int32 symbolicSampleSize)
{
    return symbolicSampleSize == Vst::kSample32 ? kResultTrue : kResultFalse;
}

tresult PLUGIN_API ChainsawMetalVST3Processor::process (Vst::ProcessData& data)
{
...
tresult PLUGIN_API ChainsawMetalVST3Processor::setState (IBStream* state)
{
    if (!state)
        return kResultFalse;
...
tresult PLUGIN_API ChainsawMetalVST3Processor::getState (IBStream* state)
{
    if (!state)
        return kResultFalse;
...
const ChainsawMetalVST3Processor::DescriptorArray& ChainsawMetalVST3Processor::descriptors () noexcept
{
    return DSP::getParameterDescriptors ();
}

void ChainsawMetalVST3Processor::applyAllParametersToDSP () noexcept
{
    for (const auto& descriptor : descriptors ())
    {
        applyParameterToDSP (
...
void ChainsawMetalVST3Processor::applyParameterToDSP (
    Vst::ParamID id,
    ...
    for (auto& processor : processors_)
    {
        switch (id)
        {
            ...
            case PedalParameterIDs::Drive:
                processor.setGain (static_cast<float> (normalizedValue));
                break;
            ...
            case PedalParameterIDs::QualityMode:
                ...
                break;
            case PedalParameterIDs::VoiceMode:
                processor.setVoiceMode (static_cast<ChainsawVoiceMode> (normalizedToIndex (id, normalizedValue, 3)));
                break;
            case PedalParameterIDs::PreBoostGain:
                processor.setPreBoostGainDb (realValue);
                break;
            case PedalParameterIDs::PreBoostFrequency:
                processor.setPreBoostFrequencyHz (realValue);
                break;
            case PedalParameterIDs::PreBoostQ:
                processor.setPreBoostQ (realValue);
                break;
            case PedalParameterIDs::Stage1Drive:
                processor.setStage1Drive (static_cast<float> (normalizedValue));
                break;
            case PedalParameterIDs::Stage1Softness:
                processor.setStage1Softness (static_cast<float> (normalizedValue));
                break;
            case PedalParameterIDs::Stage2Drive:
                processor.setStage2Drive (static_cast<float> (normalizedValue));
                break;
            case PedalParameterIDs::HardThreshold:
                processor.setHardThreshold (realValue);
                break;
            case PedalParameterIDs::InterstageGain:
                processor.setInterstageGainDb (realValue);
                break;
            case PedalParameterIDs::LowMidGain:
                processor.setLowMidGainDb (realValue);
                break;
            case PedalParameterIDs::LowMidFrequency:
                processor.setLowMidFrequencyHz (realValue);
                break;
            case PedalParameterIDs::LowMidQ:
                processor.setLowMidQ (realValue);
                break;
            case PedalParameterIDs::HighMidGain:
                processor.setHighMidGainDb (realValue);
                break;
            case PedalParameterIDs::HighMidFrequency:
                processor.setHighMidFrequencyHz (realValue);
                break;
            case PedalParameterIDs::HighMidQ:
                processor.setHighMidQ (realValue);
                break;
            case PedalParameterIDs::FizzCutFrequency:
                processor.setFizzCutHz (realValue);
                break;
            case PedalParameterIDs::TightLowCut:
                processor.setTightLowCutHz (realValue);
                break;
...
float ChainsawMetalVST3Processor::normalizedToReal (
    Vst::ParamID id,
    Vst::ParamValue normalizedValue) noexcept
{
...
int ChainsawMetalVST3Processor::normalizedToIndex (
    Vst::ParamID id,
...
void ChainsawMetalVST3Processor::clearRemainingOutputs (Vst::ProcessData& data, int32 firstBus) noexcept
{
