...
class SustainerVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    SustainerVST3Processor ();
    ~SustainerVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new SustainerVST3Processor;
    }
