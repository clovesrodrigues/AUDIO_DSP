...
class VintageFuzzVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    VintageFuzzVST3Processor ();
    ~VintageFuzzVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new VintageFuzzVST3Processor;
    }
