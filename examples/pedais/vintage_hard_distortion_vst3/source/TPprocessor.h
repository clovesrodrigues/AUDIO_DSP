...
class VintageHardDistortionVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    VintageHardDistortionVST3Processor ();
    ~VintageHardDistortionVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new VintageHardDistortionVST3Processor;
    }
