...
class ClassicOverdriveVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    ClassicOverdriveVST3Processor ();
    ~ClassicOverdriveVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new ClassicOverdriveVST3Processor;
    }
