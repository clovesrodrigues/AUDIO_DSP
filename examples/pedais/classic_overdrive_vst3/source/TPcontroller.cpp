...
#if CLASSIC_OVERDRIVE_VST3_ENABLE_CV_GUI
...
namespace CV {
namespace {
using DSP = cvdsp::guitar::pedals::ClassicOverdriveDSP<float>;
}

tresult PLUGIN_API ClassicOverdriveVST3Controller::initialize (FUnknown* context)
{
...
tresult PLUGIN_API ClassicOverdriveVST3Controller::terminate ()
{
    return EditControllerEx1::terminate ();
}

tresult PLUGIN_API ClassicOverdriveVST3Controller::setComponentState (IBStream* state)
{
    if (!state)
        return kResultFalse;
...
tresult PLUGIN_API ClassicOverdriveVST3Controller::setState (IBStream* /*state*/)
{
    return kResultTrue;
}

tresult PLUGIN_API ClassicOverdriveVST3Controller::getState (IBStream* /*state*/)
{
    return kResultTrue;
}

IPlugView* PLUGIN_API ClassicOverdriveVST3Controller::createView (FIDString name)
{
