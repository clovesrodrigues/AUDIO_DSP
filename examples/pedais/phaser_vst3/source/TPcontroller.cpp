...
namespace CV {
namespace {
using DSP = cvdsp::guitar::pedals::PhaserDSP<float>;
}

tresult PLUGIN_API PhaserVST3Controller::initialize (FUnknown* context)
{
...
tresult PLUGIN_API PhaserVST3Controller::terminate ()
{
    return EditControllerEx1::terminate ();
}

tresult PLUGIN_API PhaserVST3Controller::setComponentState (IBStream* state)
{
    if (!state)
        return kResultFalse;
...
tresult PLUGIN_API PhaserVST3Controller::setState (IBStream* /*state*/)
{
    return kResultTrue;
}

tresult PLUGIN_API PhaserVST3Controller::getState (IBStream* /*state*/)
{
    return kResultTrue;
}

IPlugView* PLUGIN_API PhaserVST3Controller::createView (FIDString name)
{
