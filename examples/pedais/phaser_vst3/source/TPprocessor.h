...
class PhaserVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    PhaserVST3Processor ();
    ~PhaserVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new PhaserVST3Processor;
    }
