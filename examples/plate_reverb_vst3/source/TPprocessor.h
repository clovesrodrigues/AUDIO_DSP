...
class PlateReverbVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    PlateReverbVST3Processor ();
    ~PlateReverbVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new PlateReverbVST3Processor;
    }
...
protected:
    using DSP = cvdsp::reverb::PlateReverb<float>;
