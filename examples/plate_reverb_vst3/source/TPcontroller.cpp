...
#if PLATE_REVERB_VST3_ENABLE_CV_GUI
...
tresult PLUGIN_API PlateReverbVST3Controller::initialize (FUnknown* context)
{
...
tresult PLUGIN_API PlateReverbVST3Controller::terminate ()
{
    return EditControllerEx1::terminate ();
}

tresult PLUGIN_API PlateReverbVST3Controller::setComponentState (IBStream* state)
{
    if (!state)
        return kResultFalse;
...
tresult PLUGIN_API PlateReverbVST3Controller::setState (IBStream* /*state*/)
{
    return kResultTrue;
}

tresult PLUGIN_API PlateReverbVST3Controller::getState (IBStream* /*state*/)
{
    return kResultTrue;
}

IPlugView* PLUGIN_API PlateReverbVST3Controller::createView (FIDString name)
{
