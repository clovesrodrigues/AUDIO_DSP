...
class TubeSaturationVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    TubeSaturationVST3Processor ();
    ~TubeSaturationVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new TubeSaturationVST3Processor;
    }
