...
Exemplo VST3 de tone stack clássico usando `CV_DSP/Guitar/VoxToneStack.hpp` e a classe real `cvdsp::VoxToneStack<float>`.
...
```bash
cmake -S examples/vox_tone_vst3 -B build/vox_tone_vst3 -G "MinGW Makefiles"
cmake --build build/vox_tone_vst3 --parallel
```

Artefato Windows esperado:

```text
build/vox_tone_vst3/out/vox_tone_vst3/vox_tone_vst3.vst3
```
