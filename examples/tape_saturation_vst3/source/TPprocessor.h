...
#include "CV_DSP/Saturation/TapeSaturation.hpp"
...
class TapeSaturationVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    TapeSaturationVST3Processor ();
    ~TapeSaturationVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new TapeSaturationVST3Processor;
    }
...
protected:
    using DSP = cvdsp::saturation::TapeSaturation<float>;
