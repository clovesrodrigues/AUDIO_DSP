...
#include "CV_DSP/Filters/StateVariableFilter.hpp"
...
class StateVariableFilterVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    StateVariableFilterVST3Processor ();
    ~StateVariableFilterVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new StateVariableFilterVST3Processor;
    }
...
protected:
    using DSP = cvdsp::filters::StateVariableFilter<float>;
