...
class RoomReverbVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    RoomReverbVST3Processor ();
    ~RoomReverbVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new RoomReverbVST3Processor;
    }
...
protected:
    using DSP = cvdsp::reverb::RoomReverb<float>;
