...
#include "CV_DSP/Saturation/Waveshaper.hpp"
...
class WaveshaperVST3Processor : public Steinberg::Vst::AudioEffect
{
public:
    WaveshaperVST3Processor ();
    ~WaveshaperVST3Processor () SMTG_OVERRIDE;

    static Steinberg::FUnknown* createInstance (void* /*context*/)
    {
        return (Steinberg::Vst::IAudioProcessor*)new WaveshaperVST3Processor;
    }
...
protected:
    using DSP = cvdsp::saturation::Waveshaper<float>;
